...
const Module2Dojo = () => {
    ...
    const stopCamera = () => {
        try {
            console.log(
                "🎥 Starting comprehensive camera cleanup in Module2Dojo..."
            );
            ...
            console.log("🎥 Camera cleanup completed in Module2Dojo");
        } catch (error) {
            console.error("Error stopping camera in Module2Dojo:", error);
        }
    };
